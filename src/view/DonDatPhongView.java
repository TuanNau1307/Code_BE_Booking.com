 ...
 * @author HP
 */
public class DonDatPhongView extends javax.swing.JFrame {

    ResultSet result;
    private DonDatDAO DAO = new DonDatDAO();
    private ArrayList<DonDatPhong> list;
    ...
    public DonDatPhongView() {
        ...
        model.setColumnIdentifiers(new Object[]{
            "STT", "Mã đặt", "Mã Tài Khoản ","Mã Phòng" ,"Check In","Check Out","Ghi Chú"
        });
        showResult();
    }
    ...
    private void initComponents() {
        ...
        jLabel12.setText("DANH SÁCH ĐƠN ĐẶT PHÒNG");
    ...
    public void showResult() {
        model.setRowCount(0);
        int i = 1;
        for (DonDatPhong r : list) {
            model.addRow(new Object[]{
                i++, r.getMaDat(), r.getMaTaikhoan(),r.getMaPhong(),r.getNgayCheckIn(),r.getNgayCheckout(),r.getGhiChu()
            });
        }
    }
...
//        showResult();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DonDatPhongView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
