...
import controller.ServiceDAO_T;
 ...
 * @author Minh Duc
 */
public class ServiceView1 extends javax.swing.JFrame {

      ResultSet result;
    private ServiceDAO_T SvDAO = new ServiceDAO_T();
    private ArrayList<Service_T> list;
    ...
    public void showTable() {
        int i = 1;
        for (Service_T r : list) {
            model.addRow(new Object[]{
                i++, r.getMaDichVu(),r.getTenDichVu()
            });
        }
    }
    ...
    public void showResultTK() {
        model.setRowCount(0);
        int i = 1;
        for (Service_T DV : listTK) {
            model.addRow(new Object[]{
                i++, DV.getMaDichVu(),DV.getTenDichVu()});
        }
    }
    
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
         Service_T serviceSelect = new Service_T();
        selectedIndex = tblService.getSelectedRow();
        serviceSelect = list.get(selectedIndex);
        txtID.setText(String.valueOf(serviceSelect.getMaDichVu()));
        txtName.setText(String.valueOf(serviceSelect.getTenDichVu()));
        showResult();
    }//GEN-LAST:event_btnEditActionPerformed

    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        Service_T r = new Service_T();
        r.setMaDichVu(Integer.valueOf(txtID.getText()));
        r.setTenDichVu(txtName.getText());
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
       ServiceDAO_T SvInfomationDAO = new ServiceDAO_T();
        Service_T r = new Service_T();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ServiceView1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
